 ...
 */
export const remoteStart = async (req, res) => {
    try {
        ...
        logger.info(`Remote start successful: charger ${chargerId}, connector ${connectorId}`);
 ...
 */
export const remoteStop = async (req, res) => {
    try {
        ...
        logger.info(`Remote stop successful: charger ${chargerId}, transaction ${transactionId}`);
        res.json({ success: true, ...result });
    }
    catch (error) {
 ...
 */
export const getChargerConfiguration = async (req, res) => {
    try {
 ...
 */
export const setChargerConfiguration = async (req, res) => {
    try {
 ...
 */
export const resetChargerController = async (req, res) => {
    try {
 ...
 */
export const unlockConnectorController = async (req, res) => {
    try {
 ...
 */
export const triggerMessageController = async (req, res) => {
    try {
        ...
        logger.info(`Trigger message sent to charger ${chargerId}: ${requestedMessage}`);
        res.json({ success: true, ...result });
    }
    catch (error) {
